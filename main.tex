...
Splitting the sample to opponents and supporters and examining the fraud's effect for these groups hints towards the mechanism of belief updating being responsible for the observed effects: the spillover can be observed for both subgroups, potentially due to the lack of source of the message in the treatment. 
