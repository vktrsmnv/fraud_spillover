...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,trim=4 4 4 4,clip]{figs/main_hdi89.png}
    \caption{The Effects of Exposure to Fraud and Punishment Information on Confidence in Political Institutions (based on ordered logit model estimates).  \\
