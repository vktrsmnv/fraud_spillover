...
In testing Hypothesis 1, we are interested in the mean difference between the control group (1) and treatment group (2) in Table 1, i.e. those individuals who have only received information about fraud.
...
Furthermore, we use a pre-treatment party affiliation measure--in particular, being the opponent to the incumbent regime--as a moderator.   
